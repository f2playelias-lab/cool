...
local function ConnectEvents()
    ...
    local function OnValidationSuccess()
        ...
        -- Execute The Strongest Battlegrounds script
        loadstring(game:HttpGet("https://raw.githubusercontent.com/f2playelias-lab/TheStrongestBtl/refs/heads/main/TsbMainScript.lua"))()
    end
